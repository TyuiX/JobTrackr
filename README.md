...
-g, --ghosted [x days in which you consider you are consider ghosted]: list out companies that never responded in x certain days, default is to is set as 21 days.
